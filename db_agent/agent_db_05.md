...
Khi soạn output cuối cùng: xem system prompt mục 6 (Output style framework) cho layer đang active, `agent_db_00` mục 5 (K hygiene — cấm lộ ký hiệu nội bộ và taxonomy), cùng bảng dịch thuật ngữ ở phần 9 của file này.
