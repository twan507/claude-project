...
**Lưu ý audience:** file gốc soạn cho agent phục vụ NĐT khách Finext; trong pack này audience là analyst/broker nội bộ (`K_agent_db_00` mục 4.4) — chỗ nào hành văn "khách" đọc là "user cuối của output". Nội dung số liệu, luật trình bày, disclaimer giữ nguyên giá trị.

**Luật nền (`K_agent_db_00` mục 4.3 + 4.6, nhắc lại vì quan trọng nhất file):** NHÃN pha của hệ CHỈ trích từ
