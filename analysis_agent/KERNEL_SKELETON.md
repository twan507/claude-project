...
**Weight balance — chuẩn institutional outlook:** báo cáo tháng (horizon 1-3, 3-6 tháng) phải dùng signal **vĩ mô + cơ bản + chính sách + catalyst dài hơi làm PRIMARY (~60-70%)** — đây là factor có time-to-play-out khớp horizon. **Định vị thị trường + flow là SECONDARY (~20-25%)**. **Technical là TERTIARY (~10-15%) — chỉ làm confirmation timing**, không phải primary trigger. Trục 5 kịch bản, Trục 6 watchlist signal, sector tilts disconfirming đều phải base trên macro/fundamental/policy/catalyst trước, technical chỉ confirmation phụ. Weekly mode được phép lean technical cao hơn (~20%) vì tracking ngắn hạn cần signal nhanh, nhưng anchor vẫn là thesis monthly.
